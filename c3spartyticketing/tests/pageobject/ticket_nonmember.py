...
class TicketNonmemberObject(BasePageObject):
    """
    Page Objects for Member Tickets
    """
    ...
    supportl = CheckboxElement(locators["ticket.nonmember.supportl"])
    ...
    # tshirt_type = RadiobuttonElement(locators[
    #     "ticket.nonmember.tshirt.type"])
    # tshirt_size = RadiobuttonElement(
    #     locators["ticket.nonmember.tshirt.size"])
