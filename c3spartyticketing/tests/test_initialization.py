...
from c3spartyticketing import scripts # just to trigger coverage
...
class TestDBInitialization(unittest.TestCase):
    ...
    def test_usage(self):
        from c3spartyticketing.scripts.initializedb import usage
...
#
    ...
    def test_main(self):
        from c3spartyticketing.scripts.initializedb import main
        ...
        try:
            argv = ['initialize_c3spartyticketing_db', 'development.ini']
            result = main(argv)
            print("the result: %s" % result)
        except:
            print ("caught exception!")
