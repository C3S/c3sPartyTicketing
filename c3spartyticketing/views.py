...
def party_view(request):
    ...
    class PersonalData(colander.MappingSchema):
        ...
        comment = colander.SchemaNode(
            ...
            description=_("Space for comments"),
            oid="comment",
        )
    ...
    ticket_type_options = (
        (1, _(u'Economy (5€: party + concert)')),
        (2, _(u'First Class (15€: party + concert + food)')),
        (3, _(u'Business Class (100€: party + concert + food + beverages)')),
    )
    ...
    class PartyTickets(colander.MappingSchema):
        num_tickets = colander.SchemaNode(
            ...
            title=_(u"I want to buy the following number "
                    u"of Tickets (specify type below!)"),
            description=_(
                u'You can choose any amount of tickets between 1 and 10.'),
            default="1",
            ...
            validator=colander.Range(
                min=1,
                max=10,
                min_err=_(u"You need at least one ticket to travel."),
                max_err=_(u"You may choose 10 tickets at most. (busy place)"),
            ),
            oid="num_tickets")

        ticket_type = colander.SchemaNode(
            colander.Integer(),
            title=_(u"I want my tickets to be in the following category"),
            description=_(
                u'You can choose a special ticket to help fund the party — and C3S.'),
            default="1",
    ...
    class TicketForm(colander.Schema):
        ...
        ticket_info = PartyTickets(
            title=_(u"Ticketing Information")
        )
        #shares = FoodInfo(
...
def confirm_view(request):
    ...
    class PartyTickets(colander.MappingSchema):
        num_tickets = colander.SchemaNode(
            colander.Integer(),
            title=_(u"I buy the following number "
                    u"of tickets"),
            default="1",
            ...
            validator=colander.Range(
                min=1,
                max=10,
                min_err=_(u"You need at least one ticket for 5 Euro."),
                max_err=_(u"You may choose 10 tickets at most. (50 Euro)"),
            ),
            oid="num_tickets")
        ...
        ticket_type_options = (
            ...
            (3, _(u'1. Klasse (100€: party, bands, essen, kaffee, shirt)')),
        )
    ...
    ro_form = deform.Form(
        ...
        buttons=[
            deform.Button('sendmail',
                          _(u'Yes, send me a confirmation Email!')),
            deform.Button('reedit',
                          _(u'Wait, let me edit again...'))
        ],
        use_ajax=True,
        renderer=zpt_renderer
    )
